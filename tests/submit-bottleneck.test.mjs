...
r = scoreAssessment({ revenue: '0-5k', q1: 'b', q2: 'b', q3: 'b', q4: 'b', q5: 'b' });
...
r = scoreAssessment({ revenue: '5-10k', q1: 'c', q2: 'b', q3: 'c', q4: 'e', q5: 'e' });
